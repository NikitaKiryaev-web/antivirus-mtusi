...
void ServiceManager::uninstall()
{
	...
	DeleteFile(L"Scanners.kir");
	DeleteFile(L"Monitors.kir");
	DeleteFile(L"Threats.kir");
...
{
	HKEY hKey;
	if (RegOpenKeyEx(HKEY_LOCAL_MACHINE, TEXT("SOFTWARE\\AntiVirus"),
		0, KEY_READ | KEY_WOW64_64KEY, &hKey) == ERROR_SUCCESS)
	{
		RegCloseKey(hKey);

		RegDeleteTree(HKEY_LOCAL_MACHINE, TEXT("SOFTWARE\\AntiVirus"));
	}
}
